...
x2 = np.random.randn(n_samples, 2) + np.array([500])
...
gmm = GaussianMixtureModel(n_components=n_components, log_steps=False, log_initial_step=True, fixed_priors=False)
gmm.fit(X)
